...
Following is debug output of all {\em Entities} stored in "objectEntry" database of {\em Participant}. The whole output of receiving and processing \glref{RTPS} {\em Message} with \glref{SPDP} traffic is presented in appendix \ref[app:test1].
